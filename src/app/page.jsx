...
.fromTo(
  ...
  return (
    <div className='h-screen' id="smooth-wrapper">
      <div id="smooth-content">
        <section  className='bg-[#331707] h-[100vh] flex items-center justify-center'>
          <div ref={heroRef} className='w-[90%] md:w-[80%] lg:w-[65%] text-center flex flex-col items-center'>
        ...
        <section className='h-[100vh] bg-[#331707] flex items-center justify-center'>
          <div  ref={aboutRef} className='w-[90%] md:w-[60%] lg:w-[30%] px-4'>
        ...
        <section className='h-[100vh] bg-[#cdb9ab] flex items-center justify-center'>
